...
public class Solution_car {
    public static void main(String[] args) {
        new Solution_car.LuxuriousCar().printlnDesire();            //вызов метода в классе - классе.
        new Solution_car.CheapCar().printlnDesire();
        new Solution_car.Ferrari().printlnDesire();
        new Solution_car.Lanos().printlnDesire();
    }
